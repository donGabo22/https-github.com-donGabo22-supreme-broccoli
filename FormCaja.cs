...
namespace FundamentosdeSoftware_ProyectoSoftwareLetiFinal
{
    public partial class FormCaja : Form
    {
        ...
        private void AñadirVenta()
        {
           using (var context = new ApplicationDbContext())
           {
                var Registro1 = new Registradora();
                Registro1.Pedido=(int.Parse(lblPedido.Text));
                //PLATILLO***********************************************************
                Registro1.Platillo = lblNombrePlat.Text;
                Registro1.CaracteristicasP = lblCaracteristicasPlat.Text;
                Registro1.PreciOP = (int)Double.Parse(lblPrecioPlat.Text);
                Registro1.CantidadP = (int)Double.Parse(lblCantidadPlat.Text);
                Registro1.TotalP = (int)Double.Parse(lblTotalPlat.Text);
                //BEBIDA++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                Registro1.Bebida = lblNombreBebi.Text;
                Registro1.CaracteristicasB = lblCaracteristicasBebi.Text;
                Registro1.PrecioB = (int)Double.Parse(lblPrecioBebida.Text);
                Registro1.CantidadB = (int)Double.Parse(lblCantidadBebi.Text);
                Registro1.TotalB = (int)Double.Parse(lblTotalBebi.Text);
                //CUENTAS****************************************************************
                Registro1.TotalF = (int)Double.Parse(lblTotalApagar.Text);
                Registro1.Efectivo = (int)Double.Parse(txtEfectivo.Text);
                Registro1.Devolucion = (int)Double.Parse(lblDevolucion.Text);

                //***********************************************************
                context.Registradora.Add(Registro1);
                    //************************************************************+
                    context.SaveChanges();
           }
